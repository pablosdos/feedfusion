...
class GroupTag(models.Model):
    ...
    price_percentage_factor = models.FloatField(max_length=65535, null=True, blank=True)
...
class Product(models.Model):
    feed = models.ForeignKey("Feed", on_delete=models.CASCADE, blank=False, null=False)
    ...
    sales_price_excluding_tax = models.FloatField(
    ...
    group_tags = models.ManyToManyField("GroupTag")
